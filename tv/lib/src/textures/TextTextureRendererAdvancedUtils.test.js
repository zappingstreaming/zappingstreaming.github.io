import { extractTags, createLineStyle, layoutSpans, trimWordEnd, trimWordStart, renderLines, } from "./TextTextureRendererAdvancedUtils";
...
describe("layoutSpans", () => {
    it("should layout spans into lines", () => {
        ...
        const lines = layoutSpans(mockCtx, spans, lineStyle, 200, 0, 1, "...", false, 0, false);
...
describe("renderLines", () => {
    it("should render lines of text", () => {
        ...
        renderLines(mockCtx, lines, lineStyle, "left", 20, 100, 0);
        // expect(mockCtx.fillText).toHaveBeenCalledWith('Hello', 0, 10);
    });
});
//# sourceMappingURL=TextTextureRendererAdvancedUtils.test.js.map