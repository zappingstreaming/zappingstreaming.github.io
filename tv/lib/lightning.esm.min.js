...
__publicField(TextTokenizer, "_customTokenizer");
...
const _TextTexture = class extends Texture {
  constructor(stage) {
    super(stage);
...
__publicField(TextTexture, "forceAdvancedRenderer", false);
__publicField(TextTexture, "allowTextTruncation", true);
...
class WebPlatform {
  ...
  switchLoop(hasChanges) {
    ...
    this._loopHandler = setInterval(() => {
      ...
      const hasChanges2 = this.stage.renderFrame();
      if (hasChanges2) {
        clearInterval(this._loopHandler);
        this.startLoop();
      }
...
export {
  ...
  BorderComponent,
  BoxBlurShader,
  BlurShader as C2dBlurShader,
  DefaultShader2 as C2dDefaultShader,
  C2dGrayscaleShader,
  C2dShader,
  CircularPushShader,
  Component,
  ...
  TextTokenizer$1 as TextTokenizer,
  Texture,
  Tools,
  Utils$1 as Utils,
  VignetteShader,
  DefaultShader$1 as WebGLDefaultShader,
